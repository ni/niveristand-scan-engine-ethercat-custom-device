...
<Library LVVersion="19008000">
	...
	<Item Name="Applications" Type="Folder">
		...
		<Item Name="Build Data Folder File Path.vi" Type="VI" URL="../Applications/Build Data Folder File Path.vi"/>
	...
	<Item Name="Utility" Type="Folder">
		<Item Name="Auto Detect" Type="Folder">
			...
			<Item Name="Read Property.vi" Type="VI" URL="../Utility/Auto Detect/Read Property.vi"/>
			<Item Name="Set All.vi" Type="VI" URL="../Utility/Auto Detect/Set All.vi"/>
			<Item Name="Set Slot Programming Mode.vi" Type="VI" URL="../Utility/Auto Detect/Set Slot Programming Mode.vi"/>
		</Item>
		<Item Name="ECAT" Type="Folder">
			...
			<Item Name="Master" Type="Folder">
				...
				<Item Name="Check Master ID.vi" Type="VI" URL="../Utility/ECAT/Master/Check Master ID.vi"/>
				<Item Name="Get Master Info.vi" Type="VI" URL="../Utility/ECAT/Master/Get Master Info.vi"/>
				<Item Name="Set Master Info.vi" Type="VI" URL="../Utility/ECAT/Master/Set Master Info.vi"/>
			</Item>
		...
		<Item Name="FPGA" Type="Folder">
			<Item Name="Add FPGA Channels.vi" Type="VI" URL="../Utility/FPGA/Add FPGA Channels.vi"/>
			<Item Name="Add FPGA Section.vi" Type="VI" URL="../Utility/FPGA/Add FPGA Section.vi"/>
			<Item Name="Add FPGA.vi" Type="VI" URL="../Utility/FPGA/Add FPGA.vi"/>
			<Item Name="Clear FPGA.vi" Type="VI" URL="../Utility/FPGA/Clear FPGA.vi"/>
			<Item Name="Get FPGA Info.vi" Type="VI" URL="../Utility/FPGA/Get FPGA Info.vi"/>
			<Item Name="Get FPGA Properties.vi" Type="VI" URL="../Utility/FPGA/Get FPGA Properties.vi"/>
			<Item Name="Set FPGA Mode.vi" Type="VI" URL="../Utility/FPGA/Set FPGA Mode.vi"/>
			<Item Name="Set FPGA Properties.vi" Type="VI" URL="../Utility/FPGA/Set FPGA Properties.vi"/>
			<Item Name="Set Main FPGA Chassis Slots Programming Mode.vi" Type="VI" URL="../Utility/FPGA/Set Main FPGA Chassis Slots Programming Mode.vi"/>
		</Item>
		<Item Name="Module Slot" Type="Folder">
			<Item Name="Create Slots.vi" Type="VI" URL="../Utility/Module Slot/Create Slots.vi"/>
			<Item Name="Get Module Model.vi" Type="VI" URL="../Utility/Module Slot/Get Module Model.vi"/>
			<Item Name="Handle Subpanel VI Run State.vi" Type="VI" URL="../Utility/Module Slot/Handle Subpanel VI Run State.vi"/>
			<Item Name="Reset Slots.vi" Type="VI" URL="../Utility/Module Slot/Reset Slots.vi"/>
			<Item Name="Scan Engine Change Module.vi" Type="VI" URL="../Utility/Module Slot/Scan Engine Change Module.vi"/>
			<Item Name="Scan Engine Init Slot.vi" Type="VI" URL="../Utility/Module Slot/Scan Engine Init Slot.vi"/>
			<Item Name="Scan Engine Rename Slot.vi" Type="VI" URL="../Utility/Module Slot/Scan Engine Rename Slot.vi"/>
			<Item Name="Scan Engine Update Slot Subpanel.vi" Type="VI" URL="../Utility/Module Slot/Scan Engine Update Slot Subpanel.vi"/>
			<Item Name="Update Slot GUID.vi" Type="VI" URL="../Utility/Module Slot/Update Slot GUID.vi"/>
			<Item Name="Update Slot Name.vi" Type="VI" URL="../Utility/Module Slot/Update Slot Name.vi"/>
			<Item Name="Update Slots.vi" Type="VI" URL="../Utility/Module Slot/Update Slots.vi"/>
		</Item>
		<Item Name="Other" Type="Folder">
			<Item Name="Add Channel Properties To String Array.vi" Type="VI" URL="../Utility/Other/Add Channel Properties To String Array.vi"/>
			<Item Name="Add Custom Device Channel - Offline.vi" Type="VI" URL="../Utility/Other/Add Custom Device Channel - Offline.vi"/>
			...
			<Item Name="List Local Chassis Modules.vi" Type="VI" URL="../Utility/Other/List Local Chassis Modules.vi"/>
			...
			<Item Name="Remove Properties.vi" Type="VI" URL="../Utility/Other/Remove Properties.vi"/>
			<Item Name="Set Dependent File Properties.vi" Type="VI" URL="../Utility/Other/Set Dependent File Properties.vi"/>
			<Item Name="Set Main Settings.vi" Type="VI" URL="../Utility/Other/Set Main Settings.vi"/>
			<Item Name="Set Timing Source.vi" Type="VI" URL="../Utility/Other/Set Timing Source.vi"/>
			<Item Name="Update Controller Settings on Delete.vi" Type="VI" URL="../Utility/Other/Update Controller Settings on Delete.vi"/>
			<Item Name="Update Dialog Box.vi" Type="VI" URL="../Utility/Other/Update Dialog Box.vi"/>
		</Item>
		<Item Name="RemIO" Type="Folder">
			<Item Name="Scan Engine Init RemIO Mod.vi" Type="VI" URL="../Utility/RemIO/Scan Engine Init RemIO Mod.vi"/>
			<Item Name="Scan Engine Update RemIO Subpanel.vi" Type="VI" URL="../Utility/RemIO/Scan Engine Update RemIO Subpanel.vi"/>
		</Item>
		<Item Name="Target Communication" Type="Folder">
			<Item Name="Support" Type="Folder">
				<Item Name="ECAT Close FoE Write.vi" Type="VI" URL="../Utility/Target Communication/Support/ECAT Close FoE Write.vi"/>
				<Item Name="ECAT Download Error Handle.vi" Type="VI" URL="../Utility/Target Communication/Support/ECAT Download Error Handle.vi"/>
				<Item Name="ECAT Download Firmware Progress.vi" Type="VI" URL="../Utility/Target Communication/Support/ECAT Download Firmware Progress.vi"/>
				<Item Name="ECAT Execute FoE Write.vi" Type="VI" URL="../Utility/Target Communication/Support/ECAT Execute FoE Write.vi"/>
				<Item Name="ECAT FPGA OD FoE.vi" Type="VI" URL="../Utility/Target Communication/Support/ECAT FPGA OD FoE.vi"/>
